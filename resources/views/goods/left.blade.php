...
<body id="bg">
	...
	<div class="container">
		...
		<div class="leftsidebar_box">
			<a href="{{url('goods/index')}}" target="main"><div class="line">
			...
			<dl class="system_log">
				<dt>
					<img class="icon1" src="../laravel/img/coin03.png" />
					<img class="icon2"src="../laravel/img/coin04.png" /> 商品品牌管理
				...
				<dd>
					...
					<a class="cks" href="{{route('brand_list')}}" target="main">商品品牌展示</a>
					<img class="icon5" src="../laravel/img/coin21.png" />
				</dd>
			</dl>
			<dl class="system_log">
				<dt>
					<img class="icon1" src="../laravel/img/coin05.png" />
					<img class="icon2"src="../laravel/img/coin06.png" /> 管理员管理
					<img class="icon3"src="../laravel/img/coin19.png" />
					<img class="icon4"src="../laravel/img/coin20.png" />
				</dt>
				<dd>
					<img class="coin11" src="../laravel/img/coin111.png" />
					<img class="coin22"src="../laravel/img/coin222.png" />
					<a class="cks" href="{{route('user_add')}}"target="main">管理员添加</a>
					<img class="icon5" src="../laravel/img/coin21.png" />
					<a class="cks" href="{{route('user_list')}}"target="main">管理员展示</a>
					<img class="icon5" src="../laravel/img/coin21.png" />
				</dd>
				<dd>
					<img class="coin11" src="../laravel/img/coin111.png" />
			...
			<dl class="system_log">
				<dt>
					<img class="icon1" src="../laravel/img/coin07.png" />
					<img class="icon2"src="../laravel/img/coin08.png" /> 分类管理
					<img class="icon3"src="../laravel/img/coin19.png" />
					<img class="icon4"src="../laravel/img/coin20.png" />
				</dt>
				<dd>
					<img class="coin11" src="../laravel/img/coin111.png" />
					<img class="coin22"src="../laravel/img/coin222.png" />
					<a href="{{route('cat_add')}}" target="main"class="cks">分类添加</a>
					<a href="{{route('cat_list')}}" target="main"class="cks">分类列表</a>
					<img class="icon5" src="../laravel/img/coin21.png" />
				</dd>
			</dl>
			<dl class="system_log">
				<dt>
					<img class="icon1" src="../laravel/img/coin07.png" />
					<img class="icon2"src="../laravel/img/coin08.png" /> 珠宝首饰管理
					<img class="icon3"src="../laravel/img/coin19.png" />
					<img class="icon4"src="../laravel/img/coin20.png" />
				</dt>
				<dd>
					<img class="coin11" src="../laravel/img/coin111.png" />
					<img class="coin22"src="../laravel/img/coin222.png" />
					<a href="" target="main"class="cks">分类添加</a>
					<a href="" target="main"class="cks">分类列表</a>
					<img class="icon5" src="../laravel/img/coin21.png" />
				</dd>
			</dl>
			<dl class="system_log">
			...
			<dl class="system_log">
				<dt>
					<img class="icon1" src="../laravel/img/coin14.png" /><img class="icon2"
						src="../laravel/img/coin13.png" /> 心愿管理<img class="icon3"
						src="../laravel/img/coin19.png" /><img class="icon4"
						src="../laravel/img/coin20.png" />
				</dt>
				<dd>
					<img class="coin11" src="../laravel/img/coin111.png" /><img class="coin22"
						src="../laravel/img/coin222.png" /><a href="../wish.html" target="main"
						class="cks">心愿管理</a><img class="icon5" src="../laravel/img/coin21.png" />
				</dd>
			</dl>
			<dl class="system_log">
				<dt>
